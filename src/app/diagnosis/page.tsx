              ...
              <div className="space-y-6">
                 <div>
                    ...
                    <p className="text-muted-foreground">
                        <span className="font-medium text-foreground">{t.commonName}:</span> {result.identification.commonName[language as keyof typeof result.identification.commonName] || result.identification.commonName}
                    </p>
                    <p className="text-muted-foreground">
