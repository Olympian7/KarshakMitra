...
const consultationLinks = [
    ...
    },
    {
        ...
        description: {
            ...
            ml: 'നിങ്ങളുടെ കാർഷിക പ്രവർത്തനങ്ങൾക്ക് നേരിട്ടുള്ള, ജില്ലാതല ശാസ്ത്രീയവും സാങ്കതികവുമായ പിന്തുണ നേടുക. വ്യക്തിഗത സഹായത്തിനായി നിങ്ങളുടെ പ്രാദേശിക KVK കണ്ടെത്തുക.',
        },
